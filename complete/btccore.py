...
def build_transaction3(pubkey, value, fee):
    ...
    fee = transactions.get_transaction_fee(transactions.get_transaction_rate(),transactions.get_transaction_size(len(transidarr),2)) #assumes 2 is the number of outputs
